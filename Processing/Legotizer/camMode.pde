...
void normalCam(float standardU, float standardV) {
  ...
  perspective.colorMode(RGB);
  
  standard = max(standardU, standardV);
  
  // Sets "Eye" Coordinates, "Scene Center" Coordinates, and X,Y,Z Directions
  if (camRotation == 0) {
    perspective.camera((0.5+eye)*standard, eye*standard, (0.5+eye)*standard, focus*standardU, 0, focus*standardV, 0, -1, 0);
    perspective.noLights();
    perspective.pointLight(lightA,lightA,lightA, (0.5+eye)*standard, eye*standard, (0.5-eye)*standard);
    perspective.pointLight(lightB,lightB,lightB, (0.5-eye)*standard, eye*standard, (0.5+eye)*standard);
  } else if (camRotation == 1) {
    perspective.camera((0.5-eye)*standard, eye*standard, (0.5+eye)*standard, (1-focus)*standardU, 0, focus*standardV, 0, -1, 0);
    perspective.noLights();
    perspective.pointLight(lightA,lightA,lightA, (0.5+eye)*standard, eye*standard, (0.5+eye)*standard);
    perspective.pointLight(lightB,lightB,lightB, (0.5-eye)*standard, eye*standard, (0.5-eye)*standard);
  } else if (camRotation == 2) {
    perspective.camera((0.5-eye)*standard, eye*standard, (0.5-eye)*standard, (1-focus)*standardU, 0, (1-focus)*standardV, 0, -1, 0);
    perspective.noLights();
    perspective.pointLight(lightA,lightA,lightA, (0.5-eye)*standard, eye*standard, (0.5+eye)*standard);
    perspective.pointLight(lightB,lightB,lightB, (0.5+eye)*standard, eye*standard, (0.5-eye)*standard);
  } else if (camRotation == 3) {
    perspective.camera((0.5+eye)*standard, eye*standard, (0.5-eye)*standard, focus*standardU, 0, (1-focus)*standardV, 0, -1, 0);
    perspective.noLights();
    perspective.pointLight(lightA,lightA,lightA, (0.5-eye)*standard, eye*standard, (0.5-eye)*standard);
    perspective.pointLight(lightB,lightB,lightB, (0.5+eye)*standard, eye*standard, (0.5+eye)*standard);
  } else if (camRotation == 4) {
    perspective.camera((0.5+eye)*standard, (0.5+eye)*standard, (eye)*standard/2, 0.65*standardU, 0, 0.5*standardV, 0, -1, 0);
    perspective.noLights();
    perspective.pointLight(lightA,lightA,lightA, (eye)*standard/2, (0.5+eye)*standard, (0.5+eye)*standard);
    perspective.pointLight(lightB,lightB,lightB, (eye)*standard/2, (0.5+eye)*standard, (0.5-eye)*standard);
  } else if (camRotation == 5) {
    perspective.camera((eye)*standard/2, (0.5+eye)*standard, (0.5+eye)*standard, 0.5*standardU, 0, 0.65*standardV, 0, -1, 0);
    perspective.noLights();
    perspective.pointLight(lightA,lightA,lightA, (0.5+eye)*standard, (0.5+eye)*standard, (eye)*standard/2);
    perspective.pointLight(lightB,lightB,lightB, (0.5-eye)*standard, (0.5+eye)*standard, (eye)*standard/2);
  } else if (camRotation == 6) {
    perspective.camera((0.5-eye)*standard, (0.5+eye)*standard, (eye)*standard/2, 0.35*standardU, 0, 0.5*standardV, 0, -1, 0);
    perspective.noLights();
    perspective.pointLight(lightA,lightA,lightA, (eye)*standard/2, (0.5+eye)*standard, (0.5+eye)*standard);
    perspective.pointLight(lightB,lightB,lightB, (eye)*standard/2, (0.5+eye)*standard, (0.5-eye)*standard);
  } else if (camRotation == 7) {
    perspective.camera((eye)*standard/2, (0.5+eye)*standard, (0.5-eye)*standard, 0.5*standardU, 0, 0.35*standardV, 0, -1, 0);
    perspective.noLights();
    perspective.pointLight(lightA,lightA,lightA, (0.5-eye)*standard, (0.5+eye)*standard, (eye)*standard/2);
    perspective.pointLight(lightB,lightB,lightB, (0.5+eye)*standard, (0.5+eye)*standard, (eye)*standard/2);
  }
  ...
  perspective.perspective(fov, float(width)/float(height), cameraZ/100.0, cameraZ*1000.0);
...
//  perspective.loadMatrix();  
//  endPGL();
//  
//  // SETS EXTRINSIC CAMERA PARAMETERS (AKA where the camera is in space)
//  perspective.beginCamera();
//  perspective.resetMatrix();
//  perspective.applyMatrix(extMatrix[0],  extMatrix[1],  extMatrix[2],    extMatrix[3],
