...
// This code is a forked version of Colortizer, created purely to test the concatenation script written by Karthik in September 2015.  
// If you are not concatenating multiple cameras, use the default "Colortizer.pde" instead
